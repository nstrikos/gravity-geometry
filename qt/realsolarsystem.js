...
function paintGL(canvas) {
    ...
    var factor = 20 * Math.sin(Math.PI * counter / length) + 1;




    camera.position.x = sphere1.position.x + 1000000000 / scaleFactor * factor;
    camera.position.z = sphere1.position.z - 400000000 / scaleFactor * factor;
    camera.position.y = sphere1.position.y + 400000000 / scaleFactor * factor;
...
{
    var x = 0;
    var xstop = 4.5 * 31558118.4 / scaleFactor; //Earth period
